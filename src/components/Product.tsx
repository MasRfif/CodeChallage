  ...
  try {
    ...
    return (
      <>
        ...
        <section className="grid grid-cols-1 md:grid-cols-[400px_minmax(20px,_0.3fr)_400px]  gap-4 justify-center p-2 m-2 justify-items-center ">
          <div className="p-4">
            <div className="card w-[300px] h-[400px] bg-black flex flex-col items-center justify-center group ">
              <Image
                ...
                loading="lazy"
              ></Image>
              <div className="text-white text-xl font-bold mb-2 text-center absolute  opacity-0 group-hover:opacity-100 transition duration-300">
