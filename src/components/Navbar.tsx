      ...
      <nav className="bg-white border-gray-200 dark:bg-amber-900/20 fixed top-0 left-0 right-0 mx-auto max-w-screen-xl px-4 py-2 rounded-xl">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            ...
            md:{`${
              isOpen ? "opacity-100 h-[152px]" : "opacity-0 h-0"
            } transition-all duration-500 ease-out absolute left-0 z-10 mt-2 w-56 rounded-md bg-orange-500 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden`}"
          >
